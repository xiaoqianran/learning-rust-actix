    ...
    <article className="mx-auto max-w-3xl pb-20">
      ...
      <header className="border-b border-border pb-6">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {(lesson.format === "reference" || lesson.track === "官方对齐") ? (
        ...
        {lesson.official ? (
          <p className="mt-3">
            <a
              href={lesson.official.startsWith("http") ? lesson.official : `https://actix.rs${lesson.official}`}
              target="_blank"
              rel="noreferrer"
            ...
            <span className="ml-2 font-mono text-[11px] text-subtle">
              {lesson.official.startsWith("http") ? "官方文档" : `actix.rs${lesson.official}`}
            </span>
          </p>
        ) : null}
      </header>
